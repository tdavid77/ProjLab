...
\par{A dokumentum további részeiben részletesen kifejtjük a projekt követelményeit, a játék funkcióit, a felhasználók jellemzőit, valamint a projekt ütemtervét és a csapat által használt eszközöket.}
...
\begin{itemize}
	\item Buszvezetők: Céljuk, hogy a buszokkal a két végállomás között a lehető legtöbb kört tegyék meg. Minden megtett útért pénzt kapnak, ami a város kasszájába folyik be, tehát a buszvezetők által gyűjtött pénzből a hókotrósok is gazdálkodhatnak. A kapott pénz arányos a buszút hosszával, azaz ahány megállót az út érint.  
...
\begin{longtable}{| p{2cm} | p{4cm} | p{2.7cm} | p{2cm} | p{1.5cm} | p{2.0cm}|}
    ...
    TOOLS4 & %Azonosító
    A sószóró fej elolvasztja a havat és a jeget, és pár körig megakadályozza annak újboli kialakulását.& %Leírás
    ...
    SHOULD & %Prioritás
    Csapat & %Forrás
    Fogyóeszköz vásárlása \\ %Use-case
    \hline
    ...
    Csak akkor és csak akkor indulnak meg, amikor már minden játékos befejezte a körét. & %Ellenőrzés
    MUST & %Prioritás
    Csapat & %Forrás
    Autók vezérlése \\ %Use-case
    \hline
...
\begin{use-case}
    ...
    {Hókotró vezető}
    %forgatókönyv
	A rendszer felkínálja a választható ingyenes alapfejeket (Söprő fej vagy Jégtörő fej). A játékos kiválasztja az egyiket. A rendszer rögzíti a választást, és a hókotró ezzel a felszereléssel jön létre, illetve lép be a játéktérre.
\end{use-case}
...
\includegraphics[width=15.5cm]{docs/img/use_case_uml.png}
