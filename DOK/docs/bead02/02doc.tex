...
\begin{longtable}{| p{2cm} | p{4cm} | p{2.7cm} | p{2cm} | p{1.5cm} | p{2.0cm}|}
    ...
    Nehézségi módtól függ & %Ellenőrzés
    SHOULD & %Prioritás
    Csapat & %Forrás
    valami \\ %Use-case
    \hline
    ...
    PLAYERS1 & %Azonosító
    A játékos lehet buszvezető csak takarító.  & %Leírás
...
\begin{use-case}
    ...
    {Hókotró vezető}
    %forgatókönyv
    Forgatókönyv: A játékos a körében kiválaszt egy telephelyen tartózkodó hókotrót (vagy a közös raktárat), és valamilyen menedzsment akciót kezdeményez. A rendszer ellenőrzi a jogosultságot, az egyenleget és a gépjármű pozícióját. 
\end{use-case}
...
\begin{use-case}
    ...
    {Hókotró vezető}
    %forgatókönyv
    Forgatókönyv: A játékos kiválaszt egy megvásárolni kívánt új fejet (Hányó, Jégtörő, Söprő, Sószóró, Sárkány). A rendszer ellenőrzi az egyenletet, levonja a vételárat, az új eszköz pedig a telephely raktárába vagy közvetlenül a kiválasztott hókotróra kerül.
\end{use-case}
...
\begin{use-case}
    ...
    {Hókotró vezető}
    %forgatókönyv
    Forgatókönyv: Fogyóeszközös fej (Sószóró vagy Sárkány) esetén a játékos a lépés előtt eldöntheti és átállíthatja, hogy a fej be legyen-e kapcsolva, így spórolva a nyersanyaggal.
\end{use-case}
...
\begin{use-case}
    ...
    {Buszvezető}
    %forgatókönyv
    Forgatókönyv: A rendszer felkínálja a lehetséges útvonalakat. A játékos kiválasztja a számára megfelelőt, amelyen a busz közlekedni fog a játék során.
\end{use-case}
