...
\comment{z anal´ızis modell osztályleírásaiból azon met´odusok ´ujb´oli felsorol´asa le´ır´assal egy¨utt,
amelyek a v´altoztat´as miatt m´odosultak vagy ´ujonnan be lettek vezetve}
...
\begin{class-template-method}
    \classitem{+takaritHatas(s: Sav, h: Hokotro) : void (Override)}{Bekapcsolt állapotban kiszórja a zúzottkövet a sávra, ezáltal megakadályozva a jegen való megcsúszást}
